      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          <div id="mentorship" className="bg-gray-200 rounded-3xl p-6 sm:p-8 border-4 border-purple-400 hover:scale-105 transition-transform">
            <div className="bg-blue-400 h-40 sm:h-48 rounded-xl mb-6 overflow-hidden relative">
              <img 
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-blue-300 to-blue-500"></div>
            </div>
