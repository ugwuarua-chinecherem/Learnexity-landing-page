      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 sm:space-y-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl">Create your profile and tell us about your career, goals and aspirations</p>
          </div>
          <div className="text-center">
            <div className="bg-cyan-400 text-black w-24 h-24 sm:w-32 sm:h-32 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
            ...
            <p className="text-lg sm:text-xl">Our algorithm pairs you with mentors and opportunities that align with your ambitions</p>
          </div>
          <div className="text-center border-4 border-cyan-400 rounded-3xl py-8 sm:py-12 px-6 sm:px-8">
            ...
            <p className="text-lg sm:text-xl">Engage with mentors, apply to internships, and access exclusive resources</p>
          </div>
        </div>
      </div>
    </section>
